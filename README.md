## rviz_visual_tools (humble) - 4.2.0-1

The packages in the `rviz_visual_tools` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble rviz_visual_tools` on `Mon, 03 Aug 2026 05:58:14 -0000`
...
## rviz_visual_tools (jazzy) - 4.2.0-1

The packages in the `rviz_visual_tools` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy rviz_visual_tools` on `Mon, 03 Aug 2026 05:47:40 -0000`
...
## rviz_visual_tools (kilted) - 4.2.0-1

The packages in the `rviz_visual_tools` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted --track kilted rviz_visual_tools` on `Mon, 03 Aug 2026 05:46:30 -0000`
...
## rviz_visual_tools (rolling) - 4.1.4-1

The packages in the `rviz_visual_tools` repository were released into the `rolling` distro by running `/home/tezer/.local/bin/bloom-release --rosdistro rolling --track rolling rviz_visual_tools` on `Thu, 05 Jan 2023 14:34:13 -0000`
...
## rviz_visual_tools (humble) - 4.1.3-1
...
## rviz_visual_tools (noetic) - 3.9.0-1
...
## rviz_visual_tools (kinetic) - 3.4.0-0
...
The packages in the `rviz_visual_tools` repository were released into the `indigo` distro by running `/usr/bin/bloom-release rviz_visual_tools -t indigo -r indigo` on `Mon, 07 Dec 2015 21:13:27 -0000`
